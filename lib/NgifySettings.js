...
function NgifySettings (filePath, userSettings) {
    ...
    this._settings = {
        ...
        htmlExtension: '.html',
        htmlName: undefined, // will be calculated later
        htmlTemplate: ".run(" +
        ...
        jsExtension: '.js',
        jsAnnotation: '@ng',
        jsAnnotationRegExp: undefined, // will be auto filled from jsAnnotation value
        jsTemplates: {
...
NgifySettings.prototype._setHtmlName = function () {
    ...
    if (htmlPath) {
        ...
        if ( typeof htmlPath === 'function'){
            htmlName = htmlPath(htmlName, filePath, cwd);
            if ( !htmlName || typeof htmlName !== 'string'){
                throw new Error(`Tranform function must return string`)
            }
        }
